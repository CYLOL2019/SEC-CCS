...
population1 = population(1:NoA/2,:);
population2 = population(NoA/2+1:end,:);
Weight = zeros(NoA/2,NP);
%% assignment assets
population1(PreAss,:) = 1;
[~, I] = sort(population1,1,'descend');


Assignment = population1 * 0;
